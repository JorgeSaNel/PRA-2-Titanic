...
sensibilidad = rbind(c(1:99), c(1:99), c(1:99), c(1:99), c(1:99))
especificidad = rbind(c(1:99), c(1:99), c(1:99), c(1:99), c(1:99))

for (i in c(1:99)) {
  
  mat1 <- data.frame(table(titanic_file_train$Survived, modelo_glm_1$fitted.values > i/100))
  sensibilidad[1, i] <- ifelse(is.empty(mat1[mat1$Var1 == 1 & mat1$Var2 == "TRUE", "Freq"]), 0, mat1[mat1$Var1 == 1 & mat1$Var2 == "TRUE", "Freq"]) / (ifelse(is.empty(mat1[mat1$Var1 == 1 & mat1$Var2 == "TRUE", "Freq"]), 0, mat1[mat1$Var1 == 1 & mat1$Var2 == "TRUE", "Freq"]) + ifelse(is.empty(mat1[mat1$Var1 == 1 & mat1$Var2 == "FALSE", "Freq"]), 0, mat1[mat1$Var1 == 1 & mat1$Var2 == "FALSE", "Freq"]))
  especificidad[1, i] <- ifelse(is.empty(mat1[mat1$Var1 == 0 & mat1$Var2 == "FALSE", "Freq"]), 0, mat1[mat1$Var1 == 0 & mat1$Var2 == "FALSE", "Freq"]) / (ifelse(is.empty(mat1[mat1$Var1 == 0 & mat1$Var2 == "FALSE", "Freq"]), 0, mat1[mat1$Var1 == 0 & mat1$Var2 == "FALSE", "Freq"]) + ifelse(is.empty(mat1[mat1$Var1 == 0 & mat1$Var2 == "TRUE", "Freq"]), 0, mat1[mat1$Var1 == 0 & mat1$Var2 == "TRUE", "Freq"]))
  
  mat2 <- data.frame(table(titanic_file_train$Survived, modelo_glm_2$fitted.values > i/100))
  sensibilidad[2, i] <- ifelse(is.empty(mat2[mat2$Var1 == 1 & mat2$Var2 == "TRUE", "Freq"]), 0, mat2[mat2$Var1 == 1 & mat2$Var2 == "TRUE", "Freq"]) / (ifelse(is.empty(mat2[mat2$Var1 == 1 & mat2$Var2 == "TRUE", "Freq"]), 0, mat2[mat2$Var1 == 1 & mat2$Var2 == "TRUE", "Freq"]) + ifelse(is.empty(mat2[mat2$Var1 == 1 & mat2$Var2 == "FALSE", "Freq"]), 0, mat2[mat2$Var1 == 1 & mat2$Var2 == "FALSE", "Freq"]))
  especificidad[2, i] <- ifelse(is.empty(mat2[mat2$Var1 == 0 & mat2$Var2 == "FALSE", "Freq"]), 0, mat2[mat2$Var1 == 0 & mat2$Var2 == "FALSE", "Freq"]) / (ifelse(is.empty(mat2[mat2$Var1 == 0 & mat2$Var2 == "FALSE", "Freq"]), 0, mat2[mat2$Var1 == 0 & mat2$Var2 == "FALSE", "Freq"]) + ifelse(is.empty(mat2[mat2$Var1 == 0 & mat2$Var2 == "TRUE", "Freq"]), 0, mat2[mat2$Var1 == 0 & mat2$Var2 == "TRUE", "Freq"]))
  
  mat3 <- data.frame(table(titanic_file_train$Survived, modelo_glm_3$fitted.values > i/100))
  sensibilidad[3, i] <- ifelse(is.empty(mat3[mat3$Var1 == 1 & mat3$Var2 == "TRUE", "Freq"]), 0, mat3[mat3$Var1 == 1 & mat3$Var2 == "TRUE", "Freq"]) / (ifelse(is.empty(mat3[mat3$Var1 == 1 & mat3$Var2 == "TRUE", "Freq"]), 0, mat3[mat3$Var1 == 1 & mat3$Var2 == "TRUE", "Freq"]) + ifelse(is.empty(mat3[mat3$Var1 == 1 & mat3$Var2 == "FALSE", "Freq"]), 0, mat3[mat3$Var1 == 1 & mat3$Var2 == "FALSE", "Freq"]))
  especificidad[3, i] <- ifelse(is.empty(mat3[mat3$Var1 == 0 & mat3$Var2 == "FALSE", "Freq"]), 0, mat3[mat3$Var1 == 0 & mat3$Var2 == "FALSE", "Freq"]) / (ifelse(is.empty(mat3[mat3$Var1 == 0 & mat3$Var2 == "FALSE", "Freq"]), 0, mat3[mat3$Var1 == 0 & mat3$Var2 == "FALSE", "Freq"]) + ifelse(is.empty(mat3[mat3$Var1 == 0 & mat3$Var2 == "TRUE", "Freq"]), 0, mat3[mat3$Var1 == 0 & mat3$Var2 == "TRUE", "Freq"]))
  
  mat4 <- data.frame(table(titanic_file_train$Survived, modelo_glm_4$fitted.values > i/100))
  sensibilidad[4, i] <- ifelse(is.empty(mat4[mat4$Var1 == 1 & mat4$Var2 == "TRUE", "Freq"]), 0, mat4[mat4$Var1 == 1 & mat4$Var2 == "TRUE", "Freq"]) / (ifelse(is.empty(mat4[mat4$Var1 == 1 & mat4$Var2 == "TRUE", "Freq"]), 0, mat4[mat4$Var1 == 1 & mat4$Var2 == "TRUE", "Freq"]) + ifelse(is.empty(mat4[mat4$Var1 == 1 & mat4$Var2 == "FALSE", "Freq"]), 0, mat4[mat4$Var1 == 1 & mat4$Var2 == "FALSE", "Freq"]))
  especificidad[4, i] <- ifelse(is.empty(mat4[mat4$Var1 == 0 & mat4$Var2 == "FALSE", "Freq"]), 0, mat4[mat4$Var1 == 0 & mat4$Var2 == "FALSE", "Freq"]) / (ifelse(is.empty(mat4[mat4$Var1 == 0 & mat4$Var2 == "FALSE", "Freq"]), 0, mat4[mat4$Var1 == 0 & mat4$Var2 == "FALSE", "Freq"]) + ifelse(is.empty(mat4[mat4$Var1 == 0 & mat4$Var2 == "TRUE", "Freq"]), 0, mat4[mat4$Var1 == 0 & mat4$Var2 == "TRUE", "Freq"]))
  
  mat5 <- data.frame(table(titanic_file_train$Survived, modelo_glm_5$fitted.values > i/100))
  sensibilidad[5, i] <- ifelse(is.empty(mat5[mat5$Var1 == 1 & mat5$Var2 == "TRUE", "Freq"]), 0, mat5[mat5$Var1 == 1 & mat5$Var2 == "TRUE", "Freq"]) / (ifelse(is.empty(mat5[mat5$Var1 == 1 & mat5$Var2 == "TRUE", "Freq"]), 0, mat5[mat5$Var1 == 1 & mat5$Var2 == "TRUE", "Freq"]) + ifelse(is.empty(mat5[mat5$Var1 == 1 & mat5$Var2 == "FALSE", "Freq"]), 0, mat5[mat5$Var1 == 1 & mat5$Var2 == "FALSE", "Freq"]))
  especificidad[5, i] <- ifelse(is.empty(mat5[mat5$Var1 == 0 & mat5$Var2 == "FALSE", "Freq"]), 0, mat5[mat5$Var1 == 0 & mat5$Var2 == "FALSE", "Freq"]) / (ifelse(is.empty(mat5[mat5$Var1 == 0 & mat5$Var2 == "FALSE", "Freq"]), 0, mat5[mat5$Var1 == 0 & mat5$Var2 == "FALSE", "Freq"]) + ifelse(is.empty(mat5[mat5$Var1 == 0 & mat5$Var2 == "TRUE", "Freq"]), 0, mat5[mat5$Var1 == 0 & mat5$Var2 == "TRUE", "Freq"]))
  
}

plot(c(1:101)/100, c(1:101)/100, type = "l", col = "black", main = "Curvas ROC", xlab = "1 - especificidad", ylab = "sensibilidad")
lines(1 - c(0, especificidad[1,], 1), c(1, sensibilidad[1,], 0), type = "l", col = "blue")
lines(1 - c(0, especificidad[1,], 1), c(1, sensibilidad[2,], 0), type = "l", col = "green")
lines(1 - c(0, especificidad[1,], 1), c(1, sensibilidad[3,], 0), type = "l", col = "red")
lines(1 - c(0, especificidad[1,], 1), c(1, sensibilidad[4,], 0), type = "l", col = "purple")
lines(1 - c(0, especificidad[1,], 1), c(1, sensibilidad[5,], 0), type = "l", col = "orange")

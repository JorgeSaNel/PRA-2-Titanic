...
** DUDA: ¿Se aplica el test también sobre variables categóricas? **
```{r echo=TRUE, message=FALSE, warning=FALSE}
#fligner.test(as.numeric(Survived) ~ Pclass, data = titanic_file_train)
#fligner.test(as.numeric(Survived) ~ Sex, data = titanic_file_train)
...
#fligner.test(as.numeric(Survived) ~ Embarked, data = titanic_file_train)
...
predict(modelo_glm_5, new_person, type = "response")

...
length(titanic_file[which(titanic_file$Fare == 0 & titanic_file$Age == 0),]$Fare)
...
firmas <- matrix(c("JSN", "JCL", "JSN", "JCL", "JSN", "JCL", "JSN", "JCL", "JSN", "JCL"),ncol=2,byrow=TRUE)
colnames(firmas) <- c("Firma Jorge Santos", "Firma Javier Cela")
rownames(firmas) <- c("Contribuciones", "Investigación previa", "Limpieza de los datos", "Análisis de los datos", "Representación de los resultados")
participantes <- as.table(firmas)
participantes
```
